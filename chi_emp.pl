...
open O, ">$OutputFile";
$c = 0;
print O "chr\tWinStart\tWinStop\tNSites\tPop1SiteComps\tPop1LengthSum\tPop2SiteComps\tPop2LengthSum\tPopRatio\tRatioQuantile\n";
