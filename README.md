Local versions of scripts from membets of the Stern Lab [1] and Ben Arthur[1]. Using to generate personal datasets for D.melanogaster song using SongExplorer[2].
